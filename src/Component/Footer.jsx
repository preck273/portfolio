  ...
  return (
    <footer className="bg-gray-800 text-white py-4 px-6 flex flex-col md:flex-row items-center justify-between">
      <div className="mb-4 md:mb-0"> 
        <p className="text-xs md:text-sm">&copy; 2024 Oziwo</p> 
      </div>
      ...
      <div className="flex items-center space-x-4">
        <div className="flex items-center">
          ...
          <p className="text-xs md:text-sm ml-1">Pepelito273@outlook.com</p>
        </div>
        <div className="flex items-center">
          <i className="fas fa-phone fa-lg"></i>
          <p className="text-xs md:text-sm ml-1">0685135674</p> 
        </div>
      </div>
    </footer>
  );
